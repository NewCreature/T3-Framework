...
LOCAL_CFLAGS    := -I$(ANDROID_NDK_TOOLCHAIN_ROOT)/user/$(TARGET_ARCH_ABI)/include -I../../../src/joynet/enet-1.3.1/include -DT3F_ANDROID -DT3F_ANDROID_GP -DT3F_ANDROID_GP $(PLATFORM_CFLAGS) -DT3F_ANDROID_NATIVE_CALL_PREFIX=$(NATIVE_CALL_PREFIX)
